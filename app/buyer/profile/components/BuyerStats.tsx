...
// },
// {
// title: "connectedFarmers",
// value: "34",
// icon: Users,
// color: "bg-blue-100 text-blue-700",
// },
// {
// title: "activeRequirements",
// value: "8",
// icon: ShoppingBag,
...
export default function BuyerStats({
  ...
  const stats = [
    {
      title: "completedOrders",
      value: buyer?.completedOrders ?? 0,
      icon: FileCheck,
      color: "bg-green-100 text-green-700",
    },
    {
      title: "connectedFarmers",
      value: buyer?.connectedFarmers ?? 0,
      icon: Users,
      color: "bg-blue-100 text-blue-700",
    },
    {
      title: "activeRequirements",
      value: buyer?.activeRequirements ?? 0,
      icon: ShoppingBag,
      color: "bg-amber-100 text-amber-700",
    },
    {
      title: "averageRating",
      value: buyer?.averageRating ?? "N/A",
      icon: Star,
      color: "bg-purple-100 text-purple-700",
    },
  ];
