...
//   return (
//     <div className="space-y-8 w-full text-gray-900 pb-12">
      
//       {/* Welcome Banner */}
// <div 
//   style={{ backgroundColor: '#E67E22' }} 
//   className="text-white rounded-2xl p-8 relative overflow-hidden shadow-sm flex items-center justify-between"
// >
//   <div className="space-y-2 max-w-xl z-10">
//     <h1 className="text-3xl font-bold tracking-tight text-white">Welcome, FreshMart!</h1>
//     <p className="text-white text-sm opacity-95 font-medium">
//       You have 8 new bids on your requirements and 5 active orders in progress.
//     </p>
//   </div>
//   <div className="absolute right-8 opacity-15 hidden md:block z-0">
//     <Package size={140} className="stroke-1 text-white" />
//   </div>
// </div>
...
// import React from 'react';
// import { useRouter } from 'next/navigation';
// import { Sprout, ArrowRight, Sparkles, ShieldCheck, Zap } from 'lucide-react';
// import { Button } from '@/components/ui/button';
...
//   return (
//     <div className="w-full space-y-8 p-6 text-black bg-[#F8F6F0] min-h-screen">
//       {/* Welcome Card */}
...
//   return (
//     <div className="w-full space-y-6 p-6 text-black bg-[#F8F6F0] min-h-screen">
//       {/* Welcome Card */}
//       <div className="bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-2xl px-8 py-6 shadow-md">
//         <p className="text-amber-100 text-sm font-medium">Buyer Dashboard</p>
//         <h1 className="text-3xl font-bold mt-2">Welcome Back, FreshMart 👋</h1>
