...
function BuyerFarmerChatDashboardContent() {
  const router = useRouter()
  const searchParams = useSearchParams()
  const { t } = useLanguage()
  ...
  useEffect(() => {
    ...
    const farmer = farmers.find((item) => item.name === farmerName)
  ...
  const filteredFarmers = useMemo(() => {
    if (farmerName) {
      return farmers.filter((farmer) => farmer.name === farmerName)
    }
      ...
      <div className="w-full border-r border-gray-200 bg-white md:w-80">
        ...
        <div className="border-b border-gray-200 p-4">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder={t('buyerMessages.searchFarmers')}
              value={searchQuery}
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mb-1 text-xs text-gray-600">{farmer.cropType}</p>
                  <p className="truncate text-xs text-gray-600">
                    {farmer.lastMessage}
                  </p>
                </div>
        ...
        <div className="hidden flex-1 flex-col bg-[#F5F0E6] md:flex">
          ...
          <div className="border-b border-gray-200 bg-white p-4">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <p className="text-sm font-semibold text-gray-800">
                  {t('buyerMessages.trustScore')}: {selectedFarmer.trustScore}
                </p>
          ...
          <div className="border-t border-gray-200 bg-white p-4">
            <div className="flex items-center gap-3">
              ...
              <input
                type="text"
                placeholder={t('buyerMessages.typeYourMessage')}
                value={messageInput}
        ...
        <div className="flex flex-1 flex-col bg-[#F5F0E6] md:hidden">
          ...
          <div className="border-t border-gray-200 bg-white p-4">
            <div className="flex items-center gap-3">
              ...
              <input
                type="text"
                placeholder={t('buyerMessages.typeMessage')}
                value={messageInput}
                onChange={(event) => setMessageInput(event.target.value)}
                onKeyDown={(event) => {
                  if (event.key === 'Enter') {
...
// Suspense Boundary Wrapper Export for Next.js Build
export default function BuyerFarmerChatDashboard() {
  return (
    <Suspense fallback={<div className="flex h-screen items-center justify-center bg-[#F5F0E6]">Loading Chat...</div>}>
      <BuyerFarmerChatDashboardContent />
    </Suspense>
  )
}