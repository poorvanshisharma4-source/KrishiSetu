...
export function FinancialSupport() {
  ...
  const cards = [
    {
      icon: Landmark,
      title: t('financial.banks.title'),
      description: t('financial.banks.description'),
    },
    {
      icon: ShieldCheck,
      title: t('financial.insurance.title'),
      description: t('financial.insurance.description'),
    },
    {
      icon: FileBadge,
      title: t('financial.schemes.title'),
      description: t('financial.schemes.description'),
    },
    {
      icon: GraduationCap,
      title: t('financial.literacy.title'),
      description: t('financial.literacy.description'),
    },
  ]
